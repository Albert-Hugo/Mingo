...
import com.ido.mingo.client.config.ConfigManger;
import com.ido.mingo.client.config.ServerInfo;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        taskWorker.execute(() -> {
            try {
                ...
                Socket socket = null;
                ServerInfo serverInfo = ConfigManger.getTargetServerInfo(data.getKey());
                if(serverInfo == null){//没有找到配置信息
                    ctx.close();
                    return;
                }
